...
const FreelancerProfile = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    bio: userProfile?.bio || 'Experienced freelancer passionate about delivering high-quality work.',
    ...
    education: userProfile?.education || 'Bachelor of Science in Computer Science',
